...
- Handle keyboard arrows for navigation (UDLR)

Input
  Take a map with colors for the walls, empty string means empty space. 
  Starting point is the center of the first empty square on right-down scan.
  Example: Blue room
    ['blue','blue','blue','blue',
     'blue',''    ,''    ,'blue',
     'blue',''    ,''    ,'blue',
...
Goal
  Time yourself, how long did it take you to write it?
...
Features matter..
  ...
  Add split screen for multi player?
    Add players ability to shoot each other, and a score?
